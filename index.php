      ...
      <div class="front-text2">
        ...
        <p class="front-text2__main2-2">
          ...
          便利な<br>
              ...
              <span class="underR ct">エキナカクリニック</span>
          <ruby class="mh_tRed01">音速<rt>マッハ</rt></ruby>で帰ろう -->
          <img src="<?php echo get_template_directory_uri() ?>/assets/img/machMvSubTitle.png" class="" alt="予約でお待たせし内科">
        </p>
