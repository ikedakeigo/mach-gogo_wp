    ...
    <section class="main_mv">
      <div class="container-front2">
        <div class="front-text2">
          <p class="front-text2__main2">
            <!-- 駅なかクリニックで<br class="is-sp" />
            <ruby class="mh_tRed01">音速<rt>マッハ</rt></ruby>で帰ろう -->
              便利な<br>
              <span class="ctS">はたらく人</span>のための<br>
              <span class="underR ct">エキナカクリニック</span>
            <!-- <ruby class="mh_tRed01">音速<rt>マッハ</rt></ruby>で帰ろう -->
          </p>
        ...
        <div class="container inner">
          ...
          <div class="schedule">
            <div class="schedule-row">
              <h5><div class="schedule-day">平日</div></h5>
              <h5><div class="schedule-time">12:00〜20:00</div></h5>
            </div>
            <div class="schedule-row">
              <h5><div class="schedule-day">土日祝</div></h5>
              <h5><div class="schedule-time">9:00〜17:00</div></h5>
            </div>
            <div class="schedule-row">
