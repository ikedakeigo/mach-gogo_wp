...
{
  if (is_front_page()) {
    $title = "神戸駅ナカの待たない土日祝日診察の内科｜神戸駅ナカ内科マッハスピードクリニック";
  } elseif (is_page('naika')) {
    $title = "JR神戸駅直結の待たない内科｜神戸駅ナカ内科マッハスピードクリニック";
  } elseif (is_page('fever-clinic')) {
    $title = "神戸駅直結の待たない・断らない・土日祝日診療の発熱外来滴｜神戸駅ナカ内科マッハスピードクリニック";
  } elseif (is_page('pill-clinic')) {
    $title = "神戸駅ナカの待たないピル（２回目以降）処方｜神戸駅ナカ内科マッハスピードクリニック";
  } elseif (is_page('after-pill')) {
    $title = "神戸駅ナカで土日祝・夜間・待たずにアフターピル処方｜神戸駅ナカ内科マッハスピードクリニック";
  } elseif (is_page('self-pay-beauty')) {
    $title = "神戸駅ナカで土日祝・夜間・待たずに美白内服処方・美容点滴｜神戸駅ナカ内科マッハスピードクリニック";
  } elseif (is_page('vaccine')) {
    $title = "神戸駅ナカで土日祝・夜間・待たずにインフルエンザの予防接種｜神戸駅ナカ内科マッハスピードクリニック";
  }
  return $title;
}
